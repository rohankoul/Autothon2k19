...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public void createJSON(Iterator<SearchResult> iteratorSearchResults, String movieName)
	{
	    ...
	    try (FileWriter file = new FileWriter("C:\\Users\\I332954\\Desktop\\result.json")) {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
		...
		public String postData() throws ClientProtocolException, IOException
	       {
	       ProcessBuilder process = new ProcessBuilder("curl", "-X", "POST", "http://54.169.34.162:5252/upload", "-H", "\'content-type:multipart/form-data\'", "-F", "\"file=@C:\\Users\\I332954\\Desktop\\result.json\""); 
